function varargout = Level_3(varargin)
% LEVEL_3 MATLAB code for Level_3.fig
%      LEVEL_3, by itself, creates a new LEVEL_3 or raises the existing
%      singleton*.
%
%      H = LEVEL_3 returns the handle to a new LEVEL_3 or the handle to
%      the existing singleton*.
%
%      LEVEL_3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in LEVEL_3.M with the given input arguments.
%
%      LEVEL_3('Property','Value',...) creates a new LEVEL_3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Level_3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Level_3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Level_3

% Last Modified by GUIDE v2.5 22-Apr-2024 13:24:29

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Level_3_OpeningFcn, ...
                   'gui_OutputFcn',  @Level_3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Level_3 is made visible.
function Level_3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Level_3 (see VARARGIN)
...
% Choose default command line output for Level_3
handles.output = hObject;

% Update the text field with the initial value
handles.KpSlider = 3.54; % Initial value
handles.TiSlider = 1/0.3702;  % Initial value for the integral gain
handles.TdSlider = -0.1; % Initial value for the derivative gain
...
handles.Kpmax = handles.KpSlider + 3; handles.Kpmin =  handles.KpSlider - 3;
...
hold(handles.outputAxes, 'off' )
    ...
    xlim(handles.inputAxes,[0  200])
    ylim(handles.inputAxes,[-20  20])
...
% UIWAIT makes Level_3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Level_3_OutputFcn(hObject, eventdata, handles) 
...
% ----- Executes when change any parameters --------.
...
function closeEndTimer(~, ~, hObject)
    ...
    if handles.flag == 1
        ...
        try
        close_system('Level_3_sys',0)
        catch
        end
        %bdclose
        close(hObject)
        uiwait(Level_3_end(bestCost))
    end
